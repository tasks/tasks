...
public final class LocalyticsSession {
    ...
    /* package */static final class UploadHandler extends Handler {
         ...
         */
        /* package */
        static boolean uploadSessions(final String url, final String body) {
            if (Constants.ENABLE_PARAMETER_CHECKING) {
                if (null == url) {
         ...
         */
        /* package */
        static JSONObject getAttributesFromSession(final LocalyticsProvider provider, final String apiKey, final long sessionId) throws JSONException {
            Cursor cursor = null;
            try {
         ...
         */
        /* package */
        static JSONObject convertEventToJson(final LocalyticsProvider provider, final Context context, final long eventId, final long blobId, final String apiKey)
         ...
         */
        /* package */
        static JSONObject convertAttributesToJson(final LocalyticsProvider provider, final long eventId) throws JSONException {
            Cursor cursor = null;
            try {
