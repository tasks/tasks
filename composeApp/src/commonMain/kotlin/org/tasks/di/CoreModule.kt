...
internal val drawerDefaults = DrawerSettings()

internal val lookAndFeelDefaults = LookAndFeelSettings()

internal fun PreferencesSnapshot.lookAndFeelSettings() = LookAndFeelSettings(
...
internal fun PreferencesSnapshot.drawerSettings() = DrawerSettings(
...
internal val taskSettingDefaults = TaskDefaultSettings()

internal fun PreferencesSnapshot.notificationSettings() = NotificationSettings(
...
internal fun String.orNull(): String? = takeIf { it.isNotBlank() }
