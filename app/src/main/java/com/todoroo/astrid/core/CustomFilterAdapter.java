...
class CustomFilterAdapter extends ArrayAdapter<CriterionInstance> {
  ...
  public void onCreateContextMenu(ContextMenu menu, View v) {
    ...
    MenuItem item = menu
        .add(CustomFilterActivity.MENU_GROUP_CONTEXT_TYPE, CriterionInstance.TYPE_INTERSECT, index,
    ...
    item = menu
        .add(CustomFilterActivity.MENU_GROUP_CONTEXT_TYPE, CriterionInstance.TYPE_SUBTRACT, index,
            activity.getString(R.string.CFA_context_chain,
